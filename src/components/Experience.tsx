...
// No imports for DataPipelineFlow needed
...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-24 relative overflow-hidden bg-background scroll-mt-20">
      ...
      <div className="container max-w-7xl mx-auto px-6">
        ...
        {experiencesData.length > 1 && (
          <div className="relative max-w-3xl mx-auto mb-16 px-8 z-0">
                ...
                return (
                  <React.Fragment key={role.id}>
                    ...
                    >
                      ...
                      <div className={`w-8 h-8 rounded-full border-2 bg-white dark:bg-[#090b0e] flex items-center justify-center transition-all duration-300 relative z-10 ${
                        isActive
                      ...
                      <div className="flex flex-col items-center w-32 absolute top-10 pointer-events-none">
                        <span className={`text-[10px] font-mono font-bold tracking-widest uppercase transition-colors duration-200 text-center ${
                          isActive 
                    ...
                    {idx < experiencesData.length - 1 && (
                      <div className="flex-grow h-0.5 mx-2 relative z-0">
                        ...
                        <div className={`absolute inset-0 bg-primary rounded transition-all duration-500 ease-out ${
                          isPassed ? "w-full" : "w-0"
                        }`} />
                      </div>
                    )}
        ...
        <div className="relative w-full overflow-hidden max-w-7xl mx-auto min-h-[500px]">
                  ...
                  <div className="flex flex-col gap-4">
                    {currentRole.logoUrl ? (
                      <div className="h-10 px-3 bg-white border border-slate-200 dark:border-slate-800 rounded-lg flex items-center justify-center select-none w-fit shadow-sm">
                        <img src={currentRole.logoUrl} alt={currentRole.company} className="h-6 w-auto object-contain" />
                      </div>
                    ) : (
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center font-bold text-sm bg-gradient-to-br ${currentRole.logoBg} w-fit shadow-sm`}>
