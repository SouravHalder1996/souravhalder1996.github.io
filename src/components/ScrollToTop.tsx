    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          className="fixed bottom-5 sm:bottom-6 right-4 sm:right-6 z-50 p-2.5 sm:p-3 rounded-full border border-slate-200/80 dark:border-slate-800 bg-white/70 dark:bg-[#090b0e]/70 backdrop-blur-md shadow-lg shadow-slate-100/50 dark:shadow-none hover:shadow-primary/20 dark:hover:shadow-primary/10 hover:border-primary/50 text-muted-foreground hover:text-primary flex items-center justify-center transition-all duration-300 hover:-translate-y-1 active:scale-95 group cursor-pointer"
        >
